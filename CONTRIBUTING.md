...
* **Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/SolaceLabs/solace-aws-ha-quickstart/issues).

* If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/SolaceLabs/solace-aws-ha-quickstart/issues/new). Be sure to include a **title and clear description**, as much relevant information as possible, and a **code sample** or an **executable test case** demonstrating the expected behavior that is not occurring.
...
* Search [GitHub](https://github.com/SolaceLabs/solace-aws-ha-quickstart/pulls) for an open or closed Pull Request
...
Fork the project [on GitHub](https://github.com/SolaceLabs/solace-aws-ha-quickstart) and clone your fork
locally.
