...
* Search [GitHub](https://github.com/SolaceProducts/solace-aws-ha-quickstart/pulls) for an open or closed Pull Request
...
Fork the project [on GitHub](https://github.com/SolaceProducts/solace-aws-ha-quickstart) and clone your fork
locally.
...
```sh
$ git remote add upstream https://github.com/SolaceProducts/solace-aws-ha-quickstart
```
