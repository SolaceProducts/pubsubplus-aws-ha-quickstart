...
| Maximum Number of Client Connections (MaxClientConnections)| 100   | The maximum supported number of client connections system scaling parameter |
| Maximum Number of Queue Messages (MaxQueueMessages)     | 100   | The maximum number of queue messages system scaling parameter, in millions of messages |
